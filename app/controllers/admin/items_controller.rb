class Admin::ItemsController < ApplicationController
  ...
  private
    ...
    def item_params
      params.require(:item).permit(:number, :name, :price, :active_item, :special_price_item, :picture, {product_pictures: []}, colors_attributes: [:id, :code, :quantities, :available_date, {pictures: []}, :_destroy])
    end
