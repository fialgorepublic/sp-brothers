    ...
    $.fn.colorPick = function(config) {
        ...
        return this.each(function() {
            ...
            new $.colorPick(this, config || {}, '');
                ...
                new $.colorPick(this, config || {}, this.children[0].value);
            }
        });

    };
    
    $.colorPick = function (element, options, color) {
        options = options || {};
        ...
        var dataInitialColor = color == '' ? this.element.data('initialcolor') : color
        ...
        init : function(){
            ...
            this.element.click(function(event) {
                ...
                $('.colorPickButton').click(function(event) {
                    ...
                    this.parentElement.parentElement.parentElement.children[1].value = this.getAttribute('hexvalue')
					return false;
